...
(() => {
  ...
  // 북구는 2023-04-17 강북소방서 개서로 두 소방서가 나눠 관할한다(대구소방안전본부 공식
  // 관내현황 페이지 확인, 2026-08-29) - 북부소방서 관할이 "북구지역(칠곡 지역 제외)"라고
  // 명시돼 있어, 신도심인 칠곡지구 동(학정동 등)은 북부소방서가 아니라 강북소방서가 맞다
  // (사용자 리포트: "대구 북구 학정동로10"의 관할소방서가 오타로 나온다, 2026-08-29).
  // 강북소방서 관할 동 목록(나무위키 문서와 daegu.go.kr 관내현황 페이지가 서로 배타적으로
  // 일치 - 이 목록에 없는 북구 동은 전부 북부소방서 관할): 칠곡지구 전체 + 금호강 이북 동.
