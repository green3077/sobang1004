...
(() => {
  ...
  const GYEONGBUK_119_CENTERS = {
    ...
    "안동소방서": [
      { center: "법흥", areas: ["강남동", "안기동", "평화동", "태화동", "서구동", "명륜동", "중구동", "일직면", "남후면"] },
      { center: "용상", areas: ["용상동", "성곡동", "석동동", "송천동", "임동면", "임하면", "길안면", "남선면"] },
      { center: "풍산", areas: ["풍산읍", "풍천면", "하회마을"] },
      { center: "옥동", areas: ["옥동", "송하동", "서후면", "북후면"] },
  ...
  // 대구(DAEGU_119_CENTERS)와 경북(GYEONGBUK_119_CENTERS)은 소방서 이름이 겹치지 않으므로 그냥 합친다.
  const FIRE_119_CENTERS = { ...DAEGU_119_CENTERS, ...GYEONGBUK_119_CENTERS };
